...
module.exports = function parse(buf){
  ...
  while( buf.length - pos >= 48) {
    ...
    range_start  = bitwise.readUInt(buf, pos, 24); pos+= 24;
    range_length = bitwise.readUInt(buf, pos, 24); pos+= 24;
